...
var file_consignment_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x29,
	0x5a, 0x27, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x53, 0x6f, 0x72,
	0x6f, 0x75, 0x73, 0x68, 0x42, 0x65, 0x69, 0x67, 0x69, 0x2f, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2d, 0x67, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_consignment_proto_goTypes = []any{
...
func file_consignment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_consignment_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_consignment_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_consignment_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_consignment_proto_msgTypes[3].Exporter = func(v any, i int) any {
