...
var file_vessel_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x6f, 0x75, 0x73, 0x68, 0x42, 0x65, 0x69, 0x67, 0x69, 0x2f, 0x6d, 0x69, 0x63, 0x72,
	0x6f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2d, 0x67, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_vessel_proto_goTypes = []any{
...
func file_vessel_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_vessel_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Vessel); i {
			case 0:
				return &v.state
			case 1:
		...
		file_vessel_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_vessel_proto_msgTypes[2].Exporter = func(v any, i int) any {
